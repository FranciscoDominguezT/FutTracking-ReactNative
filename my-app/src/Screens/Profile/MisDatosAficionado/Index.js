                ...
                {!editing ? (
                    <View style={styles.dataList}>
                        <Text style={styles.dataItem}>
                            <strong>Nacionalidad:</strong> {naciones.find(n => n.id === userData.nacion_id)?.nombre || 'No especificada'}
                        </Text>
                        <Text style={styles.dataItem}>
                            <strong>Correo electrónico:</strong> {userData.email}
                        </Text>
                        <Text style={styles.dataItem}>
                            <strong>Residencia:</strong> {provincias.find(p => p.id === userData.provincia_id)?.nombre || 'No especificada'}
                        </Text>
                    </View>
                ) : (
